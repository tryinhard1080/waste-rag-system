# Daily Email Warehouse Sync with GitHub Upload
# This script:
# 1. Exports today's emails from Outlook
# 2. Converts to Gemini format
# 3. Uploads to Gemini RAG
# 4. Syncs data to GitHub (NEW!)
...
Write-Log "================================================================================"
Write-Log "Starting Daily Email Warehouse Sync (with GitHub)"
Write-Log "================================================================================"
...
# Step 4: Sync to GitHub (NEW!)
Write-Log ""
Write-Log "Step 4: Syncing data to GitHub..."
try {
    & "$PSScriptRoot\Sync-DataToGitHub.ps1" 2>&1 | ForEach-Object {
        Write-Log $_
    }
    Write-Log "✓ GitHub sync completed"
} catch {
    Write-Log "✗ GitHub sync failed: $_"
    Write-Log "Note: This is optional. Main sync completed successfully."
}
